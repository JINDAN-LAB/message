...
public class SecurityRiskpointJudgedDto extends PageVO {
     ...
     * 危险程度
     */
    @ApiModelProperty(name = "dangerDegree" , value = "")
     ...
     * 巡检类别链表
     */
    @ApiModelProperty(name = "securityPatrolClassificationList" , value = "")
    private List<SecurityPatrolClassification> securityPatrolClassificationList;

    /**
     * 巡检类别Dto链表
     */
    @ApiModelProperty(name = "securityPatrolClassificationDtoList" , value = "")
    private List<SecurityPatrolClassificationDto> securityPatrolClassificationDtoList;
}
