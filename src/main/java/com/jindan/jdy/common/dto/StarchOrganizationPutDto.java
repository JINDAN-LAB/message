...
@Data
public class StarchOrganizationPutDto extends PageVO  implements Serializable {
    ...
    StarchMaintenanceAlteration   starchOrganizationAlteration;

    List<StarchMaintainRegister>  registerList;

    List<StarchOrganizationPutSubtypeDto>  subtypeDtoList;

    List<JdyUserFile>  fileList;
