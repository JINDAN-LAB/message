...
/**   
 * @Description:TODO(风险控制点内容返回值实体类)
 * 
 * @version: V1.0
 * @author: kong
 * 
...
public class RiskPointContentResult extends Model<RiskPointContentResult> {

	private static final long serialVersionUID = 1607386623455L;
