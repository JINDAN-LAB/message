...
public class JdyPut extends Model<JdyPut> {

	private static final long serialVersionUID = 1586871916006L;
	...
	@ApiModelProperty(name = "commodityName" , value = "备注")
	private String commodityName;
	@ApiModelProperty(name = "num" , value = "备注")
	private String num;

	@ApiModelProperty(name = "facilityTypes" , value = "类型")
	private String facilityTypes;

	@ApiModelProperty(name = "specification" , value = "备注")
