...
public class WaimaoFahuo extends Model<WaimaoFahuo> {

	private static final long serialVersionUID = 1589518525807L;
	...
	@ApiModelProperty(name = "shoukuanyinhang" , value = "收款银行")
	private String shoukuanyinhang;
