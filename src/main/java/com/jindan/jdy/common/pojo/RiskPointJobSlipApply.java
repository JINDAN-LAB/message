...
public class RiskPointJobSlipApply extends Model<RiskPointJobSlipApply> {

	private static final long serialVersionUID = 1610154589690L;
	...
	@ApiModelProperty(name = "notifyPersons3" , value = "知会人3")
	private String notifyPersons3;

	@ApiModelProperty(name = "notifyPersons2" , value = "知会人2")
	private String notifyPersons2;

	@ApiModelProperty(name = "notifyPersons" , value = "知会人")
