...
public class PurchaseDecision extends Model<PurchaseDecision> {

	private static final long serialVersionUID = 1590119207664L;
	...
	@ApiModelProperty(name = "results" , value = "")
