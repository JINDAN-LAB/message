...
public class StarchAlterationPut extends Model<StarchAlterationPut> {

	private static final long serialVersionUID = 1598498597789L;

	@TableId(value = "id", type = IdType.UUID)
	@ApiModelProperty(name = "id" , value = "")
	private String id;

	@ApiModelProperty(name = "alterationId" , value = "")
